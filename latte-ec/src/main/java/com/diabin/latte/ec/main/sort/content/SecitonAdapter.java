...
public class SecitonAdapter extends BaseSectionQuickAdapter<SectionBean, BaseViewHolder>{

    private static final RequestOptions OPTIONS = new RequestOptions()
            .diskCacheStrategy(DiskCacheStrategy.ALL)
            .dontAnimate();

    public SecitonAdapter(int layoutResId, int sectionHeadResId, List<SectionBean> data) {
