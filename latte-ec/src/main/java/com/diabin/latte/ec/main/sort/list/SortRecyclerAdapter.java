...
import com.diabin.latte_core.ui.recycler.MultipleRecyclerAdapter;
import com.diabin.latte_core.ui.recycler.MultipleViewHolder;
        ...
        switch (holder.getItemViewType()) {
            case ItemType.VERTICAL_MENU_LIST:
                ...
                if (!isClicked) {
                    ...
                    itemView.setBackgroundColor(ContextCompat.getColor(mContext,R.color.item_backgraound));

                }else {
                    line.setVisibility(View.VISIBLE);
                    name.setTextColor(ContextCompat.getColor(mContext, R.color.app_mian));
                    line.setBackgroundColor(ContextCompat.getColor(mContext, R.color.app_mian));
